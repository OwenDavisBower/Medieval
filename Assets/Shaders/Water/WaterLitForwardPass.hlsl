...
Varyings LitPassVertex(Attributes input)
{
    ...
    half3 vertexLight = VertexLighting(vertexInput.positionWS, waveNormalWS);
...
#endif
    OUTPUT_SH4(vertexInput.positionWS, waveNormalWS, GetWorldSpaceNormalizeViewDir(vertexInput.positionWS), output.vertexSH, output.probeOcclusion);
#ifdef _ADDITIONAL_LIGHTS_VERTEX

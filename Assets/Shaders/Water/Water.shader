Shader "Universal Render Pipeline/Water"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Includes
            #include "WaterLitInput.hlsl"
            #include "WaterLitGBufferPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "WaterLitInput.hlsl"
            #include "WaterLitDepthNormalsPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "WaterLitInput.hlsl"
            #include_with_pragmas "WaterObjectMotionVectors.hlsl"
            ENDHLSL
        }
